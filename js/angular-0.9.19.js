 ...
 * properties:
 *
 * - `full` â€“ `{string}` â€“ full version string, e.g. "0.9.18"
 * - `major` â€“ `{number}` â€“ major version number, e.g. 0
 * - `minor` â€“ `{number}` â€“ minor version number, e.g. 9
 * - `dot` â€“ `{number}` â€“ dot version number, e.g. 18
 * - `codeName` â€“ `{string}` â€“ code name of the release, e.g. "jiggling-armfat"
 */
var version = {
