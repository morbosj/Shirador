                  ...
                  <?php 
                    ...
                    if (mysqli_num_rows($resultimg)>0) {
                      while($row3 = mysqli_fetch_assoc($resultimg)){
                        echo "<img id='person-pic' src='ad-image/". $_SESSION['userAd'] . "/".$row3['ad_image']."'>";  
                      }
                    }
                  ?> 
                  <?php 
  ...
  <script type="text/javascript">
    function deleteme(delid){
      if(confirm("Do you want to delete?")){
        window.location.href='php/delete_adpro.php?del_id=' +delid+'';
        return true;
      }
    }
           ...
           <div class="modal-content">  
                ...
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
                          ...
                          <input type="text" name="product_name" id="product_name" class="form-control" onsubmit="isSpclChar()" />  
                          <br />  
                          <label>Brand</label>  
                          <input type="text" name="brand" id="brand" class="form-control" onkeypress='onlya(event)' />
                          <br />
...
<script>
  $(document).ready(function(){  
      ...
      $('#insert_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"php/inventory/insert_ad.php",  
                     method:"POST",  
